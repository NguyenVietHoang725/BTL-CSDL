...
VALUES
		-- ĐÃ THANH TOÁN
		('001', 'HD001', '2024-11-01', '2024-11-15', 2400000 / 8, 1), -- A2P06: LP81 (2400000 / 8 = 300k)
		('002', 'HD002', '2024-12-15', '2024-12-25', 2400000 / 8, 1), -- A2P06: LP81 (300k)
		('003', 'HD003', '2024-10-01', '2024-10-10', 1600000 / 4, 1), -- A1P01: LP40 (400k)
		('004', 'HD004', '2025-01-10', '2025-01-20', 2400000 / 8, 1), -- A2P06: LP81 (300k)
		('005', 'HD005', '2025-03-01', '2025-03-10', 1600000 / 4, 1), -- A1P01: LP40 (400k)

		-- CHƯA THANH TOÁN
		('006', 'HD006', '2025-04-10', '2025-04-25', NULL, 0), -- A1P01: LP40
		('007', 'HD007', '2025-04-12', '2025-04-27', NULL, 0), -- A2P06: LP81
		('008', 'HD008', '2025-04-18', '2025-05-01', NULL, 0), -- A2P06: LP81

		-- ĐÃ THANH TOÁN
		('009', 'HD009', '2024-09-10', '2024-09-20', 2400000 / 8, 1), -- A2P06: LP81 (300k)
		('010', 'HD010', '2024-12-05', '2024-12-20', 1600000 / 4, 1), -- A1P01: LP40 (400k)
		('011', 'HD011', '2025-01-15', '2025-01-30', 1600000 / 4, 1), -- A1P02: LP40 (400k)

		-- CHƯA THANH TOÁN
		('012', 'HD012', '2025-04-15', '2025-05-01', NULL, 0), -- A1P02: LP40
		('013', 'HD013', '2025-04-20', '2025-05-05', NULL, 0), -- A2P06: LP81

		-- ĐÃ THANH TOÁN
		('014', 'HD014', '2024-10-01', '2024-10-10', 2400000 / 8, 1), -- A2P06: LP81 (300k)

		-- CHƯA THANH TOÁN
		('015', 'HD015', '2025-04-22', '2025-05-07', NULL, 0); -- A1P02: LP40

		
INSERT INTO tPTTThuePhong (MaPT, MaNV, MaSV, NgayLapPhieu, TongTien, TrangThai)
VALUES 
		('001', 'KT002', '230870261', '2024-11-16', 2400000 / 8, 1), -- A2P06: LP81 (2400000 / 8 = 300k)
		('002', 'KT002', '233212163', '2024-12-26', 2400000 / 8, 1), -- A2P06: LP81 (300k)
		('003', 'KT002', '241765996', '2024-10-11', 1600000 / 4, 1), -- A1P01: LP40 (400k)
		('004', 'KT002', '203581209', '2025-01-21', 2400000 / 8, 0), -- A2P06: LP81 (300k)
		('005', 'KT002', '240846478', '2025-03-11', 1600000 / 4, 0), -- A1P01: LP40 (400k)

		('009', 'KT002', '213129180', '2024-09-21', 2400000 / 8, 1), -- A2P06: LP81 (300k)
...
VALUES 
		('001', 'KT003', 'A2P06', '2024-09-03', '2024-09-10', 59500, '1'),
		('002', 'KT003', 'A2P06', '2024-10-03', '2024-10-10', 85500, '1'),
		('003', 'KT003', 'A2P06', '2024-11-05', '2024-11-10', 103000, '0'),
		('004', 'KT003', 'A2P06', '2025-01-05', '2025-01-10', 113600, '0');
